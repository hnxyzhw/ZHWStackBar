    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(time * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [UIView animateWithDuration:.5f
                         ...
                         animations:^{
                             ...
                             v.alpha = 0.0f;
                             v.layer.transform = CATransform3DScale(CATransform3DIdentity, 1.2, 1.2, 1);
...
//                     }];
    ...
    [UIView animateWithDuration:.5f
                     ...
                     animations:^{
                         ...
                         sup.alpha = 0.0f;
                         sup.layer.transform = CATransform3DScale(CATransform3DIdentity, 1.2, 1.2, 1);
    ...
    UIWebView *webView = [[UIWebView alloc]initWithFrame: [UIApplication sharedApplication].keyWindow.rootViewController.view.bounds];
